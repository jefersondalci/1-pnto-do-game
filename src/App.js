    ...
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:24,background:"#f5f5f5"}}>
      <div style={{...s.card,maxWidth:400,width:"100%",textAlign:"center",padding:36}}>
        ...
        <p style={{color:"#6b7280",fontSize:14,lineHeight:1.6,margin:"0 0 24px"}}>
          Seu cadastro foi enviado e está aguardando aprovação.<br/>Você receberá acesso assim que o pagamento for confirmado.
        </p>
    ...
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:24,background:"#f5f5f5"}}>
      <div style={{width:"100%",maxWidth:400}}>
        ...
        <div style={{...s.card,display:"flex",flexDirection:"column",gap:12}}>
          <div style={s.grid2}>
            <div><label style={s.label}>Nome completo</label>
              <input value={form.nome} onChange={e=>setF("nome",e.target.value)} placeholder="Seu nome" style={{width:"100%",boxSizing:"border-box"}}/></div>
            <div><label style={s.label}>Telefone / WhatsApp</label>
              <input value={form.telefone} onChange={e=>setF("telefone",e.target.value)} placeholder="(21) 99999-9999" style={{width:"100%",boxSizing:"border-box"}}/></div>
          </div>
          <div><label style={s.label}>Email</label>
            <input type="email" value={form.email} onChange={e=>setF("email",e.target.value)} placeholder="seu@email.com" style={{width:"100%",boxSizing:"border-box"}}/></div>
          <div><label style={s.label}>Usuário (para login)</label>
            <input value={form.username} onChange={e=>setF("username",e.target.value)} placeholder="sem espaços" style={{width:"100%",boxSizing:"border-box"}}/></div>
          <div style={s.grid2}>
            <div><label style={s.label}>Senha</label>
              <input type="password" value={form.password} onChange={e=>setF("password",e.target.value)} placeholder="mín. 6 caracteres" style={{width:"100%",boxSizing:"border-box"}}/></div>
            <div><label style={s.label}>Confirmar senha</label>
              <input type="password" value={form.confirm} onChange={e=>setF("confirm",e.target.value)} placeholder="repita" style={{width:"100%",boxSizing:"border-box"}}/></div>
          </div>
        ...
        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
          {tabs.map(t=>(
            <button key={t} onClick={()=>setTab(t)} style={{
              ...
              background:tab===t?"#2d6a4f":"#fff",color:tab===t?"#fff":"#444",
    ...
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      <div style={s.card}>
        ...
        <div style={{background:"#f8fafc",borderRadius:10,padding:16,marginBottom:12}}>
          <div style={{fontSize:12,fontWeight:700,color:"#374151",marginBottom:12,textTransform:"uppercase",letterSpacing:0.5}}>
            🎯 Padrão de quebra
          </div>
          <div style={{display:"flex",flexDirection:"column",gap:12}}>
            <QuickSelect label="Pontuação da quebra (como o receiver venceu o game de saque)" options={SCORE_OPTIONS} value={form.quebrou} onChange={v=>setF("quebrou",v)} color="#b45309"/>
            <QuickSelect label="Último game sacando (como terminou)" options={SCORE_OPTIONS} value={form.sac1} onChange={v=>setF("sac1",v)} color="#2d6a4f"/>
            <QuickSelect label="Penúltimo game sacando (como terminou)" options={SCORE_OPTIONS} value={form.sac2} onChange={v=>setF("sac2",v)} color="#2d6a4f"/>
          </div>
        </div>
        ...
        <div style={{background:"#f8fafc",borderRadius:10,padding:16,marginBottom:12}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:12}}>
            ...
            <div style={{display:"flex",gap:16,flexWrap:"wrap"}}>
              <div style={{flex:1}}>
                <QuickSelect label="Games do Quebrador" options={GAME_OPTIONS} value={form.quebrador} onChange={v=>setF("quebrador",v)} color="#b45309"/>
              </div>
              <div style={{flex:1}}>
                <QuickSelect label="Games do Sacador" options={GAME_OPTIONS} value={form.sacador} onChange={v=>setF("sacador",v)} color="#1e40af"/>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{background:"#f8fafc",borderRadius:10,padding:16,marginBottom:16}}>
          ...
          <input
            type="number" step="0.01" min="1" value={form.odd}
            onChange={e=>setF("odd",e.target.value)}
        ...
        <button onClick={handleAnalyze} disabled={loading} style={{width:"100%",padding:"12px 0",fontSize:15,fontWeight:600,cursor:"pointer",borderRadius:10,background:"#2d6a4f",color:"#fff",border:"none",letterSpacing:0.3}}>
          ...
          <div style={s.card}>
            ...
            <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
              ...
              <button onClick={handleSave} disabled={saved||saving} style={{
                ...
                background:saved?"#d4f7e3":"#2d6a4f",color:saved?"#1a6640":"#fff",border:"none",borderRadius:7
